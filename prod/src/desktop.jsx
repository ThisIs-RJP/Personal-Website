    ...
    <div>
        <div className="App">
            ...
            <div className='fixedWrapper'>
                <div className="navbar">
                    ...
                    <div className="details">
                        <span class="type"> /&nbsp;DevOps Engineer /&nbsp; Front-end Developer</span>
                    </div>
            ...
            <div className="firstBlock">
                <div className="profile-card-container" style={{justifyContent: "right"}}>
                ...
                <div className="profile-card-container" style={{justifyContent: "left"}}>
